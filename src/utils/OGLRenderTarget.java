...
public class OGLRenderTarget {
	...
	public OGLRenderTarget(GL2 gl, int width, int height) {
		...
		//		height, 0, GL2.GL_DEPTH_COMPONENT, GL2.GL_UNSIGNED_INT, null);
	...
	public Buffer readBuffer(){
		IntBuffer buffer = Buffers.newDirectIntBuffer(width*height);
	...
	public BufferedImage readImage(){
        ...
        raster.setPixels(0,0,width,height,buffer.array());
        return image;
    }
